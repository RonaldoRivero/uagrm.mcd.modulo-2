...
class OpacidadPulmonar:

    NOMBRE_ARCHIVO = '/opacidad-pulmonar/metadata.csv'
    TIPO_ARCHIVO_IMAGEN = '/opacidad-pulmonar/images/'
    TIPO_ARCHIVO_MASK = '/opacidad-pulmonar/masks/'
